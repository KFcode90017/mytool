...
mean_d4, median_d4, stddev_d4 = compute_statistics(frame_times_d4)
...
print('d4-modification frame_times: mean=%f, median=%f, stdev=%f' % (mean_d4, median_d4, stddev_d4))
print("\n")
...
shapiro_stat4, shapiro_p4 = stats.shapiro(frame_times_d4)
...
if shapiro_p4 > 0.05:
    shapiro_normality_d4 = "OK"
else:
    shapiro_normality_d4 = "NOT"
...
print(f"Shapiro-Wilk Test_d4: p-value = {shapiro_p4:.3f}")
print(f"Shapiro-Wilk Test_d4: {shapiro_normality_d4}")
...
anderson_stat4, anderson_critical4, anderson_significance4= stats.anderson(frame_times_d4, dist='norm')
...
if all(anderson_significance4 > 0.05):
    anderson_normality_d4 = "OK"
else:
    anderson_normality_d4 = "NOT"
...
print(f"Anderson-Darling Test_d4: statistic = {anderson_stat4:.3f}")
print(f"Anderson-Darling Test_d4: {anderson_normality_d4}")
...
ks_stat4, ks_p4 = stats.kstest(frame_times_d4, 'norm') 
...
print(f"Kolmogorov-Smirnov Test_d4: p-value = {ks_p4:.3f}")
print(f"Kolmogorov-Smirnov Test_d4: {ks_normality4}")
print("\n")
...
t_stat, t_p = stats.ttest_ind(frame_times_d1, frame_times_d4)
print('t-test d1 vs d4: t=%f, p=%f' % (t_stat, t_p))
...
u_stat, u_p = stats.mannwhitneyu(frame_times_d1, frame_times_d4)
print('Mann-Whitney U test d1 vs d4: U=%f, p=%f' % (u_stat, u_p))
...
w_stat, w_p = stats.wilcoxon(frame_times_d1, frame_times_d4)
print('Wilcoxon signed-rank test d1 vs d4: W=%f, p=%f' % (w_stat, w_p))
